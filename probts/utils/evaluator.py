...
class Evaluator:
    ...
    def get_sequence_metrics(
        self, targets, forecasts, seasonal_error=None, samples_dim=1
    ):
    ...
    def get_metrics(self, targets, forecasts, seasonal_error=None, samples_dim=1):
        ...
        # Calculate metrics for each samples
    ...
    def __call__(self, targets, forecasts, past_data, freq):
        ...
        metrics = self.get_metrics(
            targets, forecasts, seasonal_error=seasonal_error, samples_dim=1
        )
