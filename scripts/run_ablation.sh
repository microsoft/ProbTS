...
# select from ["elastst_abs_pe", "elastst_learnable_pe", "elastst_trope", 
#  "elastst_wo_trope", "elastst_wo_mask", "elastst_wo_patch", "elastst_wo_pe", "elastst_random_sample"]
MODEL=elastst_random_sample
