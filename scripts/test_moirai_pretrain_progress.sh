...
# for DATASET_ft in traffic electricity exchange weather # etth1 etth2 ettm1 ettm2 
# do
#     file_path="/data/Blob_EastUS/v-zhenwzhang/log/moirai_finetune/moirai_1.0_R_small/${DATASET_ft}/moirai_1.0_R_small_ft__val_/checkpoints"
...
#             python run.py --config config/tsfm/moirai.yaml \
#                 --seed_everything 0 \
#                 --trainer.default_root_dir "${LOG_DIR}/moirai_1.0_R_small_ft_${DATASET_ft}" \
#                 --data.data_manager.init_args.path ${DATA_DIR} \
#                 --data.data_manager.init_args.split_val true \
#                 --data.data_manager.init_args.context_length ${CTX_LEN} \
#                 --data.data_manager.init_args.prediction_length ${PRED_LEN} \
